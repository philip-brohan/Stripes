Get data sample for HadCRUT5-ERA5 comparison
============================================
...
.. literalinclude:: ../../../../../comparisons/HadCRUT5_ERA5/ensemble_E-grid/make_comparison_slice.py

Script to make the sample batch for each year:

.. literalinclude:: ../../../../../comparisons/HadCRUT5_ERA5/ensemble_E-grid/make_all_slices.py

Script to combine the annual batches into a complete sample:


.. literalinclude:: ../../../../../comparisons/HadCRUT5_ERA5/ensemble_E-grid/get_comparison_sample.py
