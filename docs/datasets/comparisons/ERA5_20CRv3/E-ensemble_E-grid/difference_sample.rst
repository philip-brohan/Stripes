Get data sample for ERA5-20CRv3 comparison
==========================================
...
.. literalinclude:: ../../../../../comparisons/ERA5_20CRv3/E-ensemble_E-grid/make_comparison_slice.py

Script to make the sample batch for each year:

.. literalinclude:: ../../../../../comparisons/ERA5_20CRv3/E-ensemble_E-grid/make_all_slices.py

Script to combine the annual batches into a complete sample:


.. literalinclude:: ../../../../../comparisons/ERA5_20CRv3/E-ensemble_E-grid/get_comparison_sample.py
