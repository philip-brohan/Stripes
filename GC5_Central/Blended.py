...
from GC5_Central.load import load_month
...
for year in range(start.year, end.year + 1):
    ...
    for month in range(1, 13):
        mdata = load_month(year, month, new_grid=new_grid, experiments=["dl339"])
...
fig.savefig("%s/%s_%s_%s.png" % (".", "GC5-Central", args.reduce, args.convolve))
