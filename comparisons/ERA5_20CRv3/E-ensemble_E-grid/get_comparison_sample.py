...
# Get the sample cube for ERA5-EUSTACE comparison
...
def get_sample_cube(start=datetime.datetime(1979,1,1,0,0),
                    end=datetime.datetime(2018,12,31,23,59)):

    slice_dir = "%s/EUSTACE/derived/ERA5_20CRv3_comparison" % \
                                    os.getenv('SCRATCH')

    # Array to store the sample in
    ndata=numpy.ma.array(numpy.zeros(((2016-1979)*12,720)),mask=False)
    dts=[]
